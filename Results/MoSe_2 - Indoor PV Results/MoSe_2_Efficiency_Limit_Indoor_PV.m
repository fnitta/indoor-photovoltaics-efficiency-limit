...
% Define material
Material_Name = "MoSe_2";

% Define material's electrical parameters here
Material_BandGap = 1.16; % units: eV
Material_me = 0.64 * electron_mass;
Material_mh = 0.97 * electron_mass;
...
Material_C = 10 ^ -29.27; % Auger coefficient; units: cm ^ 6 * s ^ -1
